...
### 1) Visualize the duration of reign mong the danish kings 
# first I downloaded my danish kings dataset by using read_csv
...
#we already made a column named Reign_Sum, which contains the data of how long each king reigned
# we plotted our data by using ggplot, where we decided to use the geom_point
#we put start Start_of_reign as our x-axis to create "a timeline", we put Reign_sum as our y-axis 

danish_kings %>% 
  ggplot(aes(x=Start_of_Reign,y=Reign_Sum))+
  geom_point(alpha=0.6,width=0.4,color="red")+
  geom_smooth()+
...
ggsave("danish_kings.png")

## 2) Historical homicide trends across Western Europe 


---
  title: "Are we more civilized today?"
author: "Adela Sobotkova and updated by Caroline"
date: " created 4 October 2021, updated 3 october 2023"
